...
public class ModeratorSignUpRequest
{
...
public class ModeratorSignUpRequestValidator: AbstractValidator<ModeratorSignUpRequest>
{
    public ModeratorSignUpRequestValidator(AppDbContext dbContext)
    {
        RuleFor(e => e.Login)
