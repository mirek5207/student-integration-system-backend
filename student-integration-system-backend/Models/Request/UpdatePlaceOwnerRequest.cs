...
public class UpdatePlaceOwnerRequest
{
...
public class UpdatePlaceOwnerRequestValidator : AbstractValidator<UpdatePlaceOwnerRequest>
{
    public UpdatePlaceOwnerRequestValidator(AppDbContext dbContext)
    {
        RuleFor(c => c.Login)
