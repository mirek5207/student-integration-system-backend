...
public class PlaceOwnerSignUpRequest
{
...
public class PlaceOwnerSignUpRequestValidator : AbstractValidator<PlaceOwnerSignUpRequest>
{
    public PlaceOwnerSignUpRequestValidator(AppDbContext dbContext)
    {
        RuleFor(e => e.Login)
